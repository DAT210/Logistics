...
class TestFlaskApi(unittest.TestCase):
    ...
    def test_add_item_no_JSON(self):
    ...
    def test_update_item(self):
        data = {'itemAmount' : 20}
        response = self.app.put('v1/locations/1/inventories/Tofu', data=json.dumps(data), content_type='application/json')
    ...
    def test_delete_item_not_found(self):
        ...
        self.assertEqual('404 NO CONTENT', response.status)
